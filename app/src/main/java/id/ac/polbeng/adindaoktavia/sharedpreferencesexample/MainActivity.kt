...
import id.ac.polbeng.adindaoktavia.sharedpreferencesexample.databinding.ActivityMainBinding

class MainActivity : AppCompatActivity() {
    private lateinit var binding: ActivityMainBinding

    companion object {
        const val RPL = "TESTFILE"  // Menambahkan konstanta RPL
    }
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val filename = "$packageName-$RPL"  // Menggunakan konstanta RPL
